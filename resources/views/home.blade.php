...
<div class="bg-white shadow-md rounded-lg p-6 container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @forelse($upcomingEvents as $event)
            <div class="bg-gray-100 p-4 rounded-lg hover:shadow-lg transition transform hover:scale-105">
    ...
    <section class="py-16 bg-blue-600 text-white text-center">
        <div class="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between">
            ...
            <div class="lg:w-1/2 mb-8 lg:mb-0">
                ...
                <a href="{{ route('donate') }}" class="bg-white text-blue-600 px-6 py-3 rounded-lg shadow hover:bg-gray-200 transition">Faire une offrande</a>
            </div>
            <!-- Image -->
            <div class="lg:w-1/2">
